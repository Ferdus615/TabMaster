  ...
  return (
    <div className="max-w-3xl mx-auto my-10">
      ...
      <p>
        ...
        carefully before using the TabMaster website, browser extension, and
        services (collectively, the "Service") operated by TabMaster ("us,"
        "we," or "our").
      </p>
      ...
      <p>
        ...
        property of TabMaster and its licensors. The Service is protected by
        copyright, trademark, and other laws of both [Your Country] and foreign
      ...
      <ul>
        ...
        <li>Could damage, disable, overburden, or impair the Service.</li>
        <li>
          Infringes upon or violates our intellectual property rights or the
      ...
      <p>
        If you purchase any product or service made available through the
      ...
      <p>
        ...
        are not owned or controlled by TabMaster.
      </p>
      <p>
        TabMaster has no control over, and assumes no responsibility for, the
        content, privacy policies, or practices of any third-party web sites or
        services. You further acknowledge and agree that TabMaster shall not be
      ...
      <p>
        TabMaster, its subsidiaries, affiliates, and its licensors do not
      ...
      <p>
        In no event shall TabMaster, nor its directors, employees, partners,
      ...
      <p>
        ...
        <strong>feriqra007@gmail.com</strong>
      </p>
    </div>
  );
};
